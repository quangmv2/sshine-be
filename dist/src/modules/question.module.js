...
const question_resolver_1 = require("../resolver/question.resolver");
const mongoose_1 = require("@nestjs/mongoose");
const question_schema_1 = require("../schema/question.schema");
const contest_module_1 = require("./contest.module");
let QuestionModule = class QuestionModule {
};
QuestionModule = __decorate([
    common_1.Module({
        imports: [
            mongoose_1.MongooseModule.forFeature([question_schema_1.QuestionSchema]),
